# The FileOps modules collects a large number of generally useful methods for working with files.  The
# methods that take basedir and options use the Cfruby::FileFind.find() method to determine which files
# to work with.
#
# Author:: David Powers
